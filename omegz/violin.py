...
def create_violin_plot():
    ...
    plt.title("Violin Plot of Spot Prices by Year and Price Area (2018+)", fontsize=16)
    plt.xlabel("Year", fontsize=14)
    plt.ylabel("Spot Price (EUR)", fontsize=14)
...
# THEN RUN python3 violin.py

###### OTHERWISE ########

# python3 omegz/violin.py
